    ...
    return (
        <>
            ...
            <div className='Actionbutton'>
                ...
                <button class="favorite styled" onClick={() => OnHandelRandomSubmit(post)}
                    type="button">
                    Click to Assigne Block
                </button>
                <button class="favorite styled" onClick={() => OnHandelResetSubmit(post)}
                ...
                {
                    newemployee?
                    <button className="favorite styled" onClick={generatePDF}>Download PDF</button>
                    :
